function [Beta,b,Ypredtest]= PL_LEAF_train(train_data_t,train_data_m,train_p_target,k,ker,C1,C2,epsi,par,tol)
...
%      
%      parameters,
%           train_data_t   - An PxD array, the ith instance of training instance is stored in train_data_t(i,:), used for predictive model induction
%           train_data_m   - An PxD array, the ith instance of training instance is stored in train_data_m(i,:), used for manifold learning in graph construction
...
y=build_label_manifold(train_data_m,train_p_target,k);
%second phase of training
[Beta,b] = plmsvr(train_data_t,y,train_p_target,ker,C1,C2,epsi,par,tol);
H = kernelmatrix(ker,train_data_t',train_data_t',par);
numtrain = size(train_data_t,1);
Ypredtest =H*Beta+repmat(b,numtrain,1);
end

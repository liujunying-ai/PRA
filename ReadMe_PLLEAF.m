%This is an exemplar file on how the PRA framework with PL-LEAF as the base learner could be used
%Type 'help PRA_PL_LEAF' under Matlab prompt for more detailed information
...
for numFold=1:numFolds
    ...
    %train & test
    [ACC_PRA(numFold), ACC_Base(numFold)] = PRA_PL_LEAF(X_train,y_train,X_test,y_test);
end
